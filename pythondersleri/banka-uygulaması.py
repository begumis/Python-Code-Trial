                    ...
                    if girilen_sifre == musteri.sifre:
                        while True:
                            ...
                            if secim2 == "1":
                                ...
                                onay = input("Kendi hesapınıza {} Tl para yatırmayı onaylıyor musunuz ? (E/H)  :".format(yatirilan_tutar))
                                if onay == "e" or onay =="E":
                                ...
                                hedef_TC = input("Para yatırılacak hesabın TC: ")
                                ...
                                cekilecek_tutar = int(input("Çekilecek tutarı giriniz: "))
                                if cekilecek_tutar <= musteri.bakiye:
                                    musteri.bakiye -= cekilecek_tutar
                                    print("İşlem tatamlandı. ")
                                    input(menu)
                                else:
                                    print("Bakiyeniz yetersiz!!")
                                    input(menu)
